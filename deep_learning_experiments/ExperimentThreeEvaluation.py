...
def build_dnn_model():
    ...
    plot_model(compiled_model, to_file="../data/experiment_cnn_dnn_stacked_1.png", show_shapes=True,
               show_layer_names=True)
    return compiled_model


keras_classifier = KerasClassifier(build_fn=build_dnn_model, epochs=20, batch_size=64)
k_fold_validation = KFold(n_splits=10, shuffle=True)
results = cross_val_score(keras_classifier, X=encoded_documents,
                          y=rawDocumentLabels, cv=k_fold_validation)
